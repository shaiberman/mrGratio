...
set(gca,'xTick',[1 2 3],'xTickLabel',{'splenium','mid-body','genu'},'FontSize',15)
...
load(fullfile(currentPath,'fiberGroups_fig3/CC_Occipital_clean_D5_L4.mat')), fg_a{1}=fg;
load(fullfile(currentPath,'fiberGroups_fig3/CC_Motor_clean_D5_L4.mat')),     fg_a{2}=fg;
load(fullfile(currentPath,'fiberGroups_fig3/CC_Orb_Frontal_clean_D5_L4.mat')),     fg_a{3}=fg;
...
R1file=fullfile(currentPath,'fiberGroups_fig3/R1_map_2DTI_ForFig.nii.gz');
